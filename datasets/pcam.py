...
NEW_CNAMES = {
    '0': 'this is a photo of healthy lymph node',  
    '1': 'this is a photo of lymph node tumor tissue'
}
...
class PCam(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        self.split_path = os.path.join(self.dataset_dir, "split_pcam.json")
        ...
        if os.path.exists(self.split_path):
            ...
            sys.exit('should have split file')
